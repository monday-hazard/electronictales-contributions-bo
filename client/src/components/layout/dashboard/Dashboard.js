    ...
    <div className="dashboard">
      <div className="dashboard-sidebar">
        ...
        <ul className="dashboard-navigation">
          <li
            className={`dashboard-title${activeTab === 'dashboard' ? ' active' : ''}`}
            onClick={activeTab !== 'dashboard' ? () => setActiveTab('dashboard') : undefined}
          >
            Dashboard
          </li>
          <li
            className={`activity-title${activeTab === 'activity' ? ' active' : ''}`}
            onClick={activeTab !== 'activity' ? () => setActiveTab('activity') : undefined}
          >
            Activité
          </li>
          <li
            className={`settings-title${activeTab === 'settings' ? ' active' : ''}`}
            onClick={activeTab !== 'settings' ? () => setActiveTab('settings') : undefined}
          >
            Settings
          </li>
        </ul>
          ...
          <ul className="dashboard-icons-nav">
            ...
            <li>
              <Link onClick={logout} to="/">
                <img alt="Picto porte" src={logoutPicto} />
              </Link>
            </li>
          </ul>
        </div>
